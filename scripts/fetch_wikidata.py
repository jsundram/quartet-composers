...
def main():
    ...
    for e in entries:
        ...
        # `canon`, never `canon or t`: a title that did not resolve has no canonical, and claiming
        # one is what sends the pageviews API after a page that was never written.
