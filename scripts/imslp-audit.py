...
def main():
    ...
    cache = json.load(open(os.path.join(ROOT, "data", "imslp-scrape.json"), encoding="utf-8"))
    ...
    w('<footer><p>Generated by <code>scripts/imslp-audit.py</code> from '
      '<code>data/imslp-scrape.json</code>, <code>data/imslp-join.json</code> and <code>chart.js</code>. '
