...
| 2014 | now |
|---|---|
| One view: cartesian fisheye, always on | Three: **fame** (quartets written against monthly readers), **scatter** (fixed axes, ordinary pan/zoom), **swarm** (force-collided, nothing overlaps, coloured by quartets written) — plus a **lens** you switch on over any of them: a *circular* fisheye over a picture that holds still |
